...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-23 11:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/63322acc-e5f6-4a91-8d92-3df3f0d29a5b.git
$ cd 63322acc-e5f6-4a91-8d92-3df3f0d29a5b
```
